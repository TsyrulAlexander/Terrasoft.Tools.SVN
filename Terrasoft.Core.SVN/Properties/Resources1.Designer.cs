...
namespace Terrasoft.Core.SVN.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Folder was added by {0} in revision {1}.
        /// </summary>
        public static string FolderAddedInRevision {
            get {
                return ResourceManager.GetString("FolderAddedInRevision", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to FolderExistAndWouldBackuped.
        /// </summary>
        public static string FolderExistAndWouldBackuped {
            get {
                return ResourceManager.GetString("FolderExistAndWouldBackuped", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Parameter {argumentNullException.ParamName} is empty..
        /// </summary>
        ...
        ///		CloseFeature  :	Пометь фитчу как завершенную, и за [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Remote folder contains a files..
        /// </summary>
        public static string RemoveFolderContainFiles {
            get {
                return ResourceManager.GetString("RemoveFolderContainFiles", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to NodeKind invalid..
        /// </summary>
        public static string ResolveConflictByNode_svnConflictEventArgs {
            get {
                return ResourceManager.GetString("ResolveConflictByNode_svnConflictEventArgs", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to MXRSKE1jdGhYMg==.
        /// </summary>
        public static string SMTPCRD {
            get {
                return ResourceManager.GetString("SMTPCRD", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Автоматическая фиксация невозможна, так присутствуют не решенные конфликты..
        /// </summary>
